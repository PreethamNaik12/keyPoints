...
import { Edit3, Delete } from '@geist-ui/icons'
    ...
    return (
            ...
            <div>
                <div class="card">
                    ...
                    <div class="actions">
                        <div className='mb-3'>
                            <Button width = "100%" type="success" onClick={() => { updateNote(note) }}><Edit3 size={20} /><Spacer inline w={.55} />Edit</Button>
                        </div>
                        <div>
                            <Button width = "100%" type="error" ghost onClick={() => {
                                refDelete.current.click();}}><Delete size={20} /><Spacer inline w={.55} />Delete</Button>
                        </div>
                    </div>
                </div>
